...
<div x-data="AlpineSelect({
	...
	<div class="relative shadow appearance-none content-center w-48 p-1 text-left bg-white border rounded-md sm:text-sm sm:leading-5"
		...
		<div class="flex flex-wrap space-x-1" x-cloak x-show="selected.length > 0">
			<template x-for="(key, index) in selected" :key="index">
				<div
					class="text-gray-800 rounded-md truncate bg-blue-300 px-5 py-0.5 my-0.5 flex flex-row items-center">
		...
		<div class="flex flex-wrap" x-cloak x-show="selected">
			<div class="text-gray-800 rounded-md truncate bg-blue-300 px-2 py-0.5 my-0.5 flex flex-row items-center">
